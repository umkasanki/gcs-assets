...
namespace modules\configuregcsvolumesmodule;
...
use craft\web\View;
use modules\configuregcsvolumesmodule\assetbundles\configuregcsvolumesmodule\ConfiguregcsvolumesModuleAsset;
use yii\base\Event;
 ...
 *
 */
class ConfiguregcsvolumesModule extends Module
{
    // Static Properties
    // =========================================================================
     ...
     * ConfiguregcsvolumesModule::$instance
     *
     * @var ConfiguregcsvolumesModule
     */
    ...
    {
        Craft::setAlias('@modules/configuregcsvolumesmodule', $this->getBasePath());
        $this->controllerNamespace = 'modules\configuregcsvolumesmodule\controllers';
        ...
        if (!isset($i18n->translations[$id]) && !isset($i18n->translations[$id . '*'])) {
            $i18n->translations[$id] = [
                ...
                'basePath' => '@modules/configuregcsvolumesmodule/translations',
    ...
    public function init()
    {
        ...
        if (Craft::$app->getRequest()->getIsCpRequest()) {
            Event::on(
                ...
                function(TemplateEvent $event) {
                    try {
                        Craft::$app->getView()->registerAssetBundle(ConfiguregcsvolumesModuleAsset::class);
        ...
        \Craft::$container->set(Volume::class, function($container, $params, $config) {
            ...
            $config['bucket'] = getenv('GCS_BUCKET_NAME');
            return new Volume($config);
        });
